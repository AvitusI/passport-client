...
const markAllRead = async (sentData) => {
  const { data } = await axios.put(`https://shownext1-7sh63dv9.b4a.run/api/notifications/readAll`, sentData, { withCredentials: true })
  return data
}
...
const markAllReadMessages = async (sentData) => { 
  const { data } = await axios.put(`https://shownext1-7sh63dv9.b4a.run/api/messagenotify/readAll`, sentData, { withCredentials: true })
  return data
}
