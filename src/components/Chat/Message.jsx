  ...
  return (
    <div className="chat-message">
        <div className={`flex ${message.sender.username === user.username ? "items-end" : "items-end justify-end"}`}>
                    ...
                    <div>
                                <span className={`px-4 py-2 rounded-full inline-block ${message.sender.username === user.username ? "bg-gray-200 text-black rounded-bl-none" : "bg-orange-500 text-white rounded-br-none"}`}>
                                      {message.content}
